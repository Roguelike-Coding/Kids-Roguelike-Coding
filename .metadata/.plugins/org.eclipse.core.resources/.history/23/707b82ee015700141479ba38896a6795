...
public class IsoTile{
	...
	public IsoTile(RenderType renderer,Point p){
		...
		tileLabel.setBounds(p.x,p.y+68,137,69);
		if(!renderer.isBackTile()){
		backLabel.setBounds(p.x,p.y,137,137);}
		else{
			backLabel.setBounds(p.x,p.y+68,137,69);
		}
	...
	public void setAllBounds(int x,int y){
		tileLabel.setBounds(x,y+68,137,69);
		if(!renderer.isBackTile()){
		backLabel.setBounds(x,y,137,137);}
		else{
			backLabel.setBounds(x,y+68,137,69);
		}
		if(!renderer.isFrontTile()){
